...
<x-layout>
    ...
    <div class="relative w-screen left-[calc(-50vw+50%)] -mt-8 h-auto">
        <div class="relative w-full mt-[8px] p-0">
            <div class="relative min-h-[600px] md:h-screen w-full overflow-hidden flex flex-col justify-end">
                ...
                <div class="relative z-10 flex justify-center px-4 pb-10 sm:pb-16 md:pb-20">
                    <div class="text-center max-w-xl mx-auto">
                        <p class="mb-4 text-sm sm:text-base md:text-lg text-slate-200 drop-shadow-md">
                        ...
                        <a
                            href="/shop"
                            class="inline-flex items-center justify-center rounded-full bg-[#7FA82E] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#6d9126] transition shadow-lg">
                            Shop Now
                        </a>
                    </div>
                </div>
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14 space-y-16 md:space-y-20">
        ...
        <section class="grid gap-10 md:grid-cols-2 md:items-center">
            <div class="space-y-4 md:space-y-5">
                <h2 class="text-2xl md:text-3xl font-semibold text-slate-900 dark:text-white">
                ...
                <div class="flex flex-wrap gap-3">
                    <a
                        href="/shop"
                        class="inline-flex items-center justify-center rounded-full bg-[#7FA82E] px-5 py-2 text-sm font-medium text-white hover:bg-[#6d9126] transition"
                    >
                        Shop All
                    </a>
                </div>
            ...
            <div class="flex justify-center md:justify-end">
                <a href="{{ route('products.show', 2) }}" class="block transform hover:scale-105 transition duration-300 cursor-pointer w-full max-w-sm">
                    <div class="bg-white dark:bg-[#121e16] border border-gray-100 dark:border-[#1f3629] rounded-2xl p-8 shadow-sm dark:shadow-none flex items-center justify-center relative">
                        <div class="absolute inset-0 bg-transparent dark:bg-white/5 rounded-2xl"></div> 
                        <img
        ...
        <section class="grid gap-10 md:grid-cols-2 md:items-center">
            <div class="flex justify-center md:justify-start order-1 md:order-none">
                <a href="{{ route('products.show', 4) }}" class="block transform hover:scale-105 transition duration-300 cursor-pointer w-full max-w-sm">
                    <div class="bg-white dark:bg-[#121e16] border border-gray-100 dark:border-[#1f3629] rounded-2xl p-8 shadow-sm dark:shadow-none flex items-center justify-center relative">
                        <div class="absolute inset-0 bg-transparent dark:bg-white/5 rounded-2xl"></div>
                        <img
            ...
            <div class="space-y-4 md:space-y-5">
                ...
                <p class="text-sm md:text-base text-slate-600 dark:text-gray-400 max-w-md">
                    Answer a few quick questions — we’ll match you with supplements that fit your goals.
                </p>

                <a
                    href="/quiz"
                    class="inline-flex items-center justify-center rounded-full bg-[#7FA82E] 0 px-5 py-2 text-sm font-medium text-white hover:bg-[#6d9126] transition"
                >
                    Take the Quiz
                </a>
            </div>
        ...
        <section class="relative isolate overflow-hidden bg-[#2B332A] px-6 py-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0 border border-transparent dark:border-[#1f3629]">
            <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-24 lg:text-left">
                ...
                <div class="mt-10 flex items-center justify-center lg:justify-start gap-x-6">
                    <a href="/register" class="rounded-full bg-[#7FA82E] px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#6d9126] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition">
                        Get Started
                    </a>
