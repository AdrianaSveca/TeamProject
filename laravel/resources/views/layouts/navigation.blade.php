            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @auth
                    <a href="{{ route('wishlist.index') }}"
                        class="relative mr-4 inline-flex items-center transition duration-150 ease-in-out
              text-white hover:text-[#7FA82E]"
                        aria-label="Wishlist">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                <x-responsive-nav-link :href="route('wishlist.index')" :active="request()->routeIs('wishlist.*')">
                    ...
                    @if (($wishlistCount ?? 0) > 0)
                        <span
                            class="ml-2 inline-flex items-center justify-center min-w-[18px] h-[18px] px-1
                                     rounded-full bg-red-600 text-white text-xs">
                            {{ $wishlistCount }}
                        </span>
                    @endif
