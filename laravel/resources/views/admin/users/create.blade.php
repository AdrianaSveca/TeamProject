<!-- This is the admin user creation page. It provides a form to create a new user with all required fields (name, email, password, role, etc.). -->
                    ...
                    <div class="p-8 md:p-12">
                        <div class="flex items-center gap-6 mb-8">
                            <div class="w-16 h-16 rounded-full bg-purple-600/10 flex items-center justify-center border border-purple-600/20">
                                <svg class="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                            </div>
                            <div>
                                <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white">Create New <span class="text-purple-600">User</span></h2>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Add a new user to the system.</p>
                            </div>
                        </div>
