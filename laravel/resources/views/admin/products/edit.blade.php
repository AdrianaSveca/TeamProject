<!-- This is the admin product edit page. It provides a form to edit an existing product with all fields pre-filled. -->
                ...
                <div class="bg-white dark:bg-[#1a2920] overflow-hidden shadow-2xl rounded-3xl border border-gray-100 dark:border-[#2a4535] transition-colors duration-300">
                    <div class="p-8 md:p-12">
                        <div class="flex items-center gap-6 mb-8">
                            ...
                            <div>
                                <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white">Edit <span class="text-blue-600">Product</span></h2>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Update product information.</p>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('admin.products.update', $product->product_id) }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="product_description" required rows="4"
                                          class="w-full rounded-lg border-gray-300 dark:border-[#2a4535] bg-white dark:bg-[#121e16] text-gray-900 dark:text-white focus:border-[#7FA82E] focus:ring-[#7FA82E]">{{ old('product_description', $product->product_description) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="product_price" required step="0.01" min="0" value="{{ old('product_price', $product->product_price) }}"
                                           class="w-full rounded-lg border-gray-300 dark:border-[#2a4535] bg-white dark:bg-[#121e16] text-gray-900 dark:text-white focus:border-[#7FA82E] focus:ring-[#7FA82E]">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="product_stock_level" required min="0" value="{{ old('product_stock_level', $product->product_stock_level) }}"
                                           class="w-full rounded-lg border-gray-300 dark:border-[#2a4535] bg-white dark:bg-[#121e16] text-gray-900 dark:text-white focus:border-[#7FA82E] focus:ring-[#7FA82E]">
                            ...
                            <div>
                                ...
                                <input type="text" name="product_image" value="{{ old('product_image', $product->product_image) }}"
                            ...
                            <div class="flex gap-4 pt-4">
                                <button type="submit" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-xl transition-colors">
                                    Update Product
                                </button>
